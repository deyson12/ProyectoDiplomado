...
class EstatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estate" do
    assert_difference('Estate.count') do
      post estates_url, params: { estate: { description: @estate.description, name: @estate.name } }
    end
  ...
  test "should update estate" do
    patch estate_url(@estate), params: { estate: { description: @estate.description, name: @estate.name } }
